...
class ResultadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resultado" do
    assert_difference('Resultado.count') do
      post resultados_url, params: { resultado: { partidaId: @resultado.partidaId, resultado: @resultado.resultado, rodadaId: @resultado.rodadaId } }, as: :json
    end
  ...
  test "should update resultado" do
    patch resultado_url(@resultado), params: { resultado: { partidaId: @resultado.partidaId, resultado: @resultado.resultado, rodadaId: @resultado.rodadaId } }, as: :json
    assert_response 200
  end
